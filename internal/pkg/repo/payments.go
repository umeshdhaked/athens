...
var payments IPaymentsRepo

type MysqlPaymentsRepo struct {
	IRepository
}

func newPaymentsRepo(mysqlDB *gorm.DB, dynamoDB *dynamodb.Client) {
	payments = &MysqlPaymentsRepo{
...
func GetPaymentsRepo() IPaymentsRepo {
	return payments
}

//func (p *MysqlPaymentsRepo) GetOrderFromId(ctx context.Context, orderId string) (*models.RzpOrder, error) {
...
//}
//
//func (p *MysqlPaymentsRepo) GetPaymentFromId(ctx context.Context, paymentId string) (*models.RzpPayment, error) {
//	var queryInput = &dynamodb.QueryInput{
...
//}
//
//func (p *MysqlPaymentsRepo) GetRefundFromId(ctx context.Context, refundId string) (*models.RzpRefunds, error) {
//	var queryInput = &dynamodb.QueryInput{
...
//}
//
//func (p *MysqlPaymentsRepo) GetCreatedOrders(ctx context.Context, createdAtBefore int64) ([]models.RzpOrder, error) {
//	var queryInput = &dynamodb.QueryInput{
//		TableName: aws.String(models.TableRzpOrders),
...
//}
//
//func (p *MysqlPaymentsRepo) GetAttemptedOrders(ctx context.Context, createdAtBefore int64) ([]models.RzpOrder, error) {
//	var queryInput = &dynamodb.QueryInput{
//		TableName: aws.String(models.TableRzpOrders),
//		IndexName: aws.String(models.IndexTableRzpOrdersIndexStatus),
//		KeyConditions: map[string]types.Condition{
...
//}
//
//func (p *MysqlPaymentsRepo) GetOrderList(ctx context.Context, pageLimit int32, lastEvaluatedKey map[string]types.AttributeValueMemberS, status string) ([]models.RzpOrder, map[string]types.AttributeValue, int32, error) {
//	var queryInput = &dynamodb.QueryInput{
//		TableName:        aws.String(models.TableRzpOrders),
